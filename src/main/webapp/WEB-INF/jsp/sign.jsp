  ...
  <div class="request">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="titlepage">
            <h2 style="color:#eb699e">Sign Up</h2>
          </div>
        </div>
      </div>
      <form class="main_form" id="request" action="/home_training/sign" method="post" style="
    height: 380px;
">
        <div class="row">
...
">
          ...
          <table>
            <tbody><tr><td>
              <div class="col-sm-12">
                <input type="submit" class="send_btn" value="Sign Up">
              </div>
            </td>
              <td>
                <div class="col-sm-12">
                  <a href="/home_training/login"><input type="button" class="send_btn" value="Login"></a>
                </div>
              </td>
            </tr>
            </tbody>
